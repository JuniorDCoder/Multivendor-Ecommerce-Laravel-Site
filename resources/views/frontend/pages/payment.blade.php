                        ...
                        <div class="wsus__payment_menu" id="sticky_sidebar">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <button class="nav-link common_btn active" id="v-pills-profile-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="v-pills-flutterwave" aria-selected="false">Mobile Money Wallet</button>
                        ...
                        <div class="tab-content" id="v-pills-tabContent" id="sticky_sidebar">
                            ...
                            aria-labelledby="v-pills-home-tab">
                                <div class="row">
                                    <div class="col-xl-12 m-auto">
                                        <div class="wsus__payment_area">
                                            <a class="nav-link common_btn text-center" href="{{route('user.flutterwave.payment')}}">Pay With Mobile Money Wallet</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
